...
CATEGORIES = {"animal":["lion", "tiger", "bear", "hyena", "jackal",
                        ...
                        "red panda", "rancoon", "koala", "camel", "turtle",
                        "shark", "parakeet", "rooster", "jaguar", "dingo",
                        "blobfish", "goat", "sloth", "frog", "axolotl",
                        "capybara", "ferret", "donkey", "squirrel", "crocodile"],
              "sports":["basketball", "hockey", "baseball", "golf", "bowling",
                        ...
                        "racketball", "pickleball", "cornhole", "polo", "table tennis",
                        "archery", "cycling", "discus throw", "pole vault", "wrestling",
                        "bowling", "cricket", "kickball", "water polo", "javelin"],
              ...
              "holidays": ["New Year's Day", "Fourth of July", "Labor Day", "Thanksgiving",
                           "Christmas", "Veterans Day", "Martin Luther King, Jr. Day",
                           "President's Day", "Memorial Day", "Juneteenth", "Independence Day",
                           "Cinco de Mayo", "Dia de los Muertos", "Boxing Day"],
              "class subjects": ["language arts", "mathematics", "science", "health",
                                 "handwriting", "physical education", "art", "music",
                                 "instrumental music", "spanish", "algebra", "consumer education",
                                 "study hall", "social studies", "programming", "keyboarding",
                                 "philosophy", "psychology", "US History", "Ancient History",
                                 "Trigonometry", "Geometry", "French", "Latin", "Greek",
                                 "Chinese", "Japanese", "ecology", "chemistry", "physics"]}
